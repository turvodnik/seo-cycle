...
- `seo/setup/setup-gap-audit.md` и `seo/setup/latest-setup-gap-audit.md` — readiness score и missing fields по рынку, бизнесу, local/ecommerce, инструментам, budget/subscriptions, spend guard и automations.
...
- `seo/setup/setup-control-plane.md` — compact readiness report: intake/profile/sources/governance/validation/tool stack/spend guard/growth roadmap/onboarding/launch-plan/context-pack/setup-gap-audit/automation + next actions.
...
- После first-run или изменения policy запускай `setup-gap-audit.py --write` и закрывай missing fields в `seo/setup/setup-gap-audit.md` до широких циклов, платных API/LLM, массового local/ecommerce или automations.
...
- Перед чтением подробных setup-отчётов открывай `context-pack.py --write` / `seo/setup/context-pack.md`, затем `setup-gap-audit.py --write` / `seo/setup/setup-gap-audit.md` и `launch-plan.py --write` / `seo/setup/launch-plan.md`; это low-token вход, список недонастроенных деталей и первый экран проекта.
...
| `setup-control-plane.py` | Единый low-token setup/readiness отчёт по intake/profile/sources/governance/validation/tool stack/spend guard/growth roadmap/onboarding/launch-plan/context-pack/setup-gap-audit/automation/task route/usage ledger | `python3 setup-control-plane.py --write` | `seo/setup/setup-control-plane.md/json`, latest validation/governance/sources/tool stack/spend/growth roadmap/onboarding/launch-plan/context-pack/setup-gap-audit/task route/usage |
...
| `setup-gap-audit.py` | Проверяет детальную готовность проекта и вопросы владельцу по бизнесу, local/ecommerce, tools, budget/subscriptions и automations | `python3 setup-gap-audit.py --write` | `seo/setup/setup-gap-audit.md/json`, `seo/setup/latest-setup-gap-audit.md/json` |
...
- `seo/setup/setup-gap-audit.md` and `seo/setup/latest-setup-gap-audit.md` — readiness score and missing fields for market, business, local/ecommerce, tools, budget/subscriptions, spend guard, and automations.
- `seo/automation-policy.yaml` — scheduled automations, approval gates, forbidden actions.
- `seo/automation-policy.generated.yaml` — generated overlay with recommended automations, tools, and approval gates; apply only after review.
- `seo/automations/automation-recommendations.md` — human-readable automation recommendations by project type/market/tools/spend guard.
...
- After first run or policy changes, run `setup-gap-audit.py --write` and close missing fields in `seo/setup/setup-gap-audit.md` before broad cycles, paid API/LLM use, bulk local/ecommerce work, or automations.
...
- Before reading detailed setup reports, run `context-pack.py --write` / open `seo/setup/context-pack.md`, then `setup-gap-audit.py --write` / open `seo/setup/setup-gap-audit.md` and `launch-plan.py --write` / open `seo/setup/launch-plan.md`; these are the low-token entry point, missing-detail checklist, and first project screen.
...
| `setup-gap-audit.py` | Checks detailed project readiness and owner questions for business, local/ecommerce, tools, budget/subscriptions, and automations | `python3 setup-gap-audit.py --write` | `seo/setup/setup-gap-audit.md/json`, `seo/setup/latest-setup-gap-audit.md/json` |
