...
- `seo/setup/setup-control-plane.md` — compact readiness report: intake/profile/sources/governance/validation/tool stack/spend guard/growth roadmap/onboarding/launch-plan/setup-blueprint/upgrade/access-key/context-pack/setup-gap-audit/automation + next actions.
...
| `setup-control-plane.py` | Единый low-token setup/readiness отчёт по intake/profile/sources/governance/validation/tool stack/spend guard/growth roadmap/onboarding/launch-plan/setup-blueprint/upgrade/access-key/context-pack/setup-gap-audit/automation/task route/usage ledger | `python3 setup-control-plane.py --write` | `seo/setup/setup-control-plane.md/json`, latest validation/governance/sources/tool stack/spend/growth roadmap/onboarding/launch-plan/setup-blueprint/upgrade/access-key/context-pack/setup-gap-audit/task route/usage |
