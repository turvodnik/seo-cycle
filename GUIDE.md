...
| `page-outline-v2.py` | Генерирует глубокие H2/H3 page briefs из research package: word counts, SEO meta, entities, keywords, visuals, copywriter notes, Answer Units, evidence, schema, internal links, E-E-A-T guard | `python3 page-outline-v2.py ./research-package --all-mvp --write`; одиночно: `--page "/tools/virtual-hair-color-try-on/"` | `page-outlines-v2/<page>.md/json` |
| `page-outline-quality.py` | Quality gate для page briefs: word-count drift, SERP/page-type lock, SEO meta, schema, internal links, Answer Units, evidence, entity orphans, visuals, fabricated first-person expertise; даёт 10-критериальный scorecard и action plan | `python3 page-outline-quality.py ./research-package --write`; коротко: `--format markdown` | `page-outline-quality.md/json`, `latest-page-outline-quality.md/json`; exit 1 при critical findings |
