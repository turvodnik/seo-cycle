...
| `orchestrator-panel.py` | Read-only latest-run panel: current stage, blockers, next reports to read, sanitized output with no command logs | `python3 orchestrator-panel.py` / `--write` / `--format json` | `seo/orchestrator/panel.md/json` |
