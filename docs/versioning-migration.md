...
seo-cycle triggers 09-monitoring/test.json --output test-iterations.md
...
3. Прогнать smoke test:
   ```bash
   seo-cycle run script psi-fetch https://yoursite.com
   seo-cycle run script gsc-fetch --days 7 --row-limit 10
   ```
