...
- `seo/research-package/page-outline-quality.md/json` или `<package>/page-outline-quality.md/json` — quality gate для page briefs: word-count drift, SERP/page-type lock, SEO meta, schema, internal links, Answer Units, evidence, entity orphans, visuals и no-fabricated-expertise; создаётся `scripts/page-outline-quality.py <package> --write`.
