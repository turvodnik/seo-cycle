...
Вынесено на данный момент:
- **`seo-keywords`** — Phase 2-3 (сбор семантики + кластеризация). Самостоятельный скилл.
- (далее по плану: `seo-entity-map`, `seo-writing`, `seo-publishing`, `seo-monitoring`.)
