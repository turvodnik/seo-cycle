...
- `seo/research-package/page-outlines-v2/*.md/json` или `<package>/page-outlines-v2/*.md/json` — глубокие page briefs уровня H2/H3: computed word count, entities, keywords, visuals, copywriter notes, Answer Units, evidence required, schema, internal links и E-E-A-T no-fabrication guard; создаётся `scripts/page-outline-v2.py <package> --page "<url|cluster|keyword>" --write`, массово: `--all-mvp --write` или `--priority P1 --write`.
