...
- Note: Google Ads is restricted for RF projects; this status is expected, not an error. Primary paid channel is yandex_direct; drafts export to Google Ads Editor CSV.
