...
class SetupOnboardingTest(unittest.TestCase):
    ...
    def test_ru_ecommerce_has_human_secret_and_policy_steps(self) -> None:
        ...
        self.assertIn("setup_blueprint", steps["run_setup_control_plane"]["proofs"])
        self.assertIn("setup_matrix_csv", steps["run_setup_control_plane"]["proofs"])
        self.assertIn("upgrade_assistant", steps["run_setup_control_plane"]["proofs"])
        self.assertIn("upgrade_questionnaire_csv", steps["run_setup_control_plane"]["proofs"])
        self.assertIn("access_key_assistant", steps["run_setup_control_plane"]["proofs"])
