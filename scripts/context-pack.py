...
def token_contract(cfg: dict[str, Any], route: dict[str, Any], launch_plan: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "max_context_input_tokens_per_phase": coerce_int(
            ...
            )), 45000, name="governance.token_policy.max_context_input_tokens_per_phase",
        ),
        "max_raw_rows_loaded": coerce_int(
            ...
            )), 200, name="governance.token_policy.max_raw_rows_loaded",
        ),
        "distillate_max_lines": coerce_int(
            ...
            )), 220, name="governance.token_policy.distillate_max_lines",
        ),
        "browser_session_budget_minutes": coerce_int(
            ...
            )), 20, name="governance.token_policy.browser_session_budget_minutes",
        ),
        "browser_pages_per_phase_cap": coerce_int(
            ...
            )), 20, name="governance.token_policy.browser_pages_per_phase_cap",
        ),
    }
