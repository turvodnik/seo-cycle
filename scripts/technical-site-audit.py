...
DEFAULT_SLUGS = [
    ...
    "gsc-indexing-queue",
    "gsc-indexing-submit",
    "gsc-indexing-recheck",
    "indexnow-submit",
    "yandex-recrawl-submit",
    "yandex-recrawl-status",
    "bing-url-inspection",
    "serpstat-audit",
    "labrika-source-pack",
    "labrika-health",
...
def build_report(cfg_path: pathlib.Path, args: argparse.Namespace) -> dict[str, Any]:
    ...
    report = write_technical_report(
        ...
        commands=[
            ...
            "seo-cycle run script gsc-url-inspection seo-cycle.yaml --input-json gsc-url-inspection.json --write",
            "seo-cycle run script bing-url-inspection seo-cycle.yaml --input-json bing-url-info.json --write",
        ],
