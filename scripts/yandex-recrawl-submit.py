...
def build_report(cfg_path: pathlib.Path, args: argparse.Namespace) -> dict[str, Any]:
    ...
    return write_technical_report(
        ...
        write=args.write,
        commands=[
            "YANDEX_OAUTH_TOKEN=*** YANDEX_USER_ID=123 YANDEX_WEBMASTER_HOST_ID=https:example.com:443 seo-cycle run script yandex-recrawl-submit seo-cycle.yaml --queue-file seo/technical/gsc-indexing-request-queue.csv --priority P0,P1 --max 20 --live --write",
