...
echo "  5. Обнови policy-файлы в seo/ при подключении NeuronWriter, Google NLP, GSC/Яндекс/Бинг и автоматизаций"
echo "  6. Запусти валидатор:"
echo "     python3 ~/.codex/skills/seo-cycle/scripts/validate-config.py"
echo "  7. Открой короткий context pack — первый файл для Claude/Codex:"
...
echo "  8. Открой setup blueprint — матрица стран/регионов/поисковиков/бизнеса/ads/tools/budget/automation:"
...
echo "  15. Посмотри governance report:"
echo "     python3 ~/.codex/skills/seo-cycle/scripts/governance-report.py --format md"
echo "  16. Перед конкретной задачей построй low-token task route:"
...
echo "  17. Проверь/запиши расход токенов и платных инструментов:"
...
echo "  18. Сгенерируй и проверь рекомендации автоматизаций:"
...
echo "  19. Проверь рекомендуемый stack инструментов/доступов:"
...
echo "  22. Создай безопасный план автоматизаций:"
echo "     python3 ~/.codex/skills/seo-cycle/scripts/automation-plan.py --write --include-disabled"
echo "  23. В Claude Code/Codex: «давай запустим SEO-цикл для категории X»"
echo ""
