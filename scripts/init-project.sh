...
echo "  4. Открой короткий context pack — первый файл для Claude/Codex:"
echo "     seo/setup/context-pack.md"
echo "     # обновить под задачу: python3 ~/.claude/skills/seo-cycle/scripts/context-pack.py --task \"аудит индексации и robots\" --write"
echo "  5. Открой setup blueprint — матрица стран/регионов/поисковиков/бизнеса/ads/tools/budget/automation:"
echo "     seo/setup/setup-blueprint.md"
echo "     seo/setup/setup-matrix.csv"
echo "     # обновить: python3 ~/.claude/skills/seo-cycle/scripts/setup-blueprint.py --write"
echo "  6. Открой единый setup report:"
echo "     seo/setup/setup-control-plane.md"
echo "     # обновить: python3 ~/.claude/skills/seo-cycle/scripts/setup-control-plane.py --write"
echo "  7. Открой вопросы по недонастроенным деталям проекта:"
...
echo "     # после заполнения CSV: python3 ~/.claude/skills/seo-cycle/scripts/setup-answer-plan.py --write"
echo "  8. Открой компактный launch contract:"
echo "     seo/setup/launch-plan.md"
echo "     # обновить: python3 ~/.claude/skills/seo-cycle/scripts/launch-plan.py --write"
echo "  9. Открой spend/subscription guard:"
echo "     seo/setup/spend-guard.md"
echo "     # обновить: python3 ~/.claude/skills/seo-cycle/scripts/spend-guard.py --write"
echo "  10. При необходимости доуточни подробный intake:"
echo "     python3 ~/.claude/skills/seo-cycle/scripts/project-intake-wizard.py --interactive --write"
echo "  11. Примени или обнови точечный project profile:"
...
echo "  12. Посмотри governance report:"
echo "     python3 ~/.claude/skills/seo-cycle/scripts/governance-report.py --format md"
echo "  13. Перед конкретной задачей построй low-token task route:"
...
echo "  14. Проверь/запиши расход токенов и платных инструментов:"
...
echo "  15. Сгенерируй и проверь рекомендации автоматизаций:"
...
echo "  16. Проверь рекомендуемый stack инструментов/доступов:"
...
echo "  19. Создай безопасный план автоматизаций:"
echo "     python3 ~/.claude/skills/seo-cycle/scripts/automation-plan.py --write --include-disabled"
echo "  20. В Claude Code/Codex: «давай запустим SEO-цикл для категории X»"
echo ""
