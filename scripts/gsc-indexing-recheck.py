...
def build_report(cfg_path: pathlib.Path, args: argparse.Namespace) -> dict[str, Any]:
    ...
    return write_technical_report(
        ...
        write=args.write,
        commands=[
            "seo-cycle run script gsc-url-inspection seo-cycle.yaml --url https://example.com/page/ --live --write",
            "seo-cycle run script gsc-indexing-queue seo-cycle.yaml --gsc-discovered-file exports/discovered-after-7d.csv --technical-check --write",
        ],
