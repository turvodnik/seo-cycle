...
def build_report(cfg_path: pathlib.Path, args: argparse.Namespace) -> dict[str, Any]:
    ...
    report = write_technical_report(
        ...
        write=args.write,
        commands=[
            "SERPSTAT_API_KEY=*** seo-cycle run script serpstat-audit seo-cycle.yaml --action projects --live --write",
            ...
            "seo-cycle run script serpstat-audit seo-cycle.yaml --input-json serpstat-basic-info.json --write",
        ],
