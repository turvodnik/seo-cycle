...
def question_meta(field: str) -> dict[str, str]:
    if field.startswith("market.") or field.startswith("project."):
        return {
            ...
            "follow_up_command": "seo-cycle intake --interactive --write",
        }
    if field.startswith("business."):
        return {
            "answer_format": "text_or_list",
            "target_file": "seo/project-intake.yaml",
            "follow_up_command": "seo-cycle intake --interactive --write && seo-cycle run script project-profile --write",
        }
    if field.startswith("marketing."):
        return {
            ...
            "follow_up_command": "seo-cycle intake --interactive --write && seo-cycle run script tool-stack-recommender --write",
        }
    ...
    if field.startswith("tools."):
        return {
            ...
            "follow_up_command": "seo-cycle run script tool-stack-recommender --write",
        }
    if field.startswith("budget."):
        return {
            "answer_format": "number_or_policy",
            "target_file": "seo-cycle.yaml; seo/tool-budget.yaml",
            "follow_up_command": "seo-cycle spend --write && seo-cycle ledger report --write",
        }
    if field.startswith("automation."):
        return {
            ...
            "follow_up_command": "seo-cycle run script automation-recommender --write && seo-cycle control-plane --write",
        }
    return {
        "answer_format": "text",
        "target_file": "seo/project-intake.yaml",
        "follow_up_command": "seo-cycle run script setup-gap-audit --write",
    }
