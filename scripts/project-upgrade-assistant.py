...
FEATURES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "title": "Page outline v3 quality gate",
        "policy_keys": [
            "page_outlines_v3_dir",
            "copywriter_ready_dir",
            "page_outline_triplets",
        ...
        "artifacts": [
            "seo/research-package/page-outlines-v3/",
            "seo/research-package/copywriter-ready/",
            "seo/research-package/page-outline-quality.md",
            "seo/research-package/drafts/",
        ],
    ...
    {
        "id": "knowledge_hub",
        "title": "Project Knowledge Hub: wiki, Obsidian vault, graph and hybrid index",
        "policy_keys": [
            "knowledge_wiki_root",
            "knowledge_obsidian_root",
            "knowledge_graph_corpus",
            "knowledge_graph_root",
            "knowledge_hybrid_index_root",
            "knowledge_project_manifest",
            "knowledge_state_summary",
            "knowledge_context_dir",
            "knowledge_latest_context_pack",
            "knowledge_latest_context_pack_json",
            "knowledge_content_taste_report",
            "knowledge_content_taste_json",
            "knowledge_wiki_preflight_report",
            "knowledge_wiki_preflight_json",
            "knowledge_review_cluster_plan",
            "knowledge_review_cluster_json",
            "knowledge_api_catalog",
            "knowledge_api_candidates",
            "knowledge_decision_log",
            "knowledge_graphify_status",
            "knowledge_graphify_local_graph",
            "knowledge_zvec_status",
            "knowledge_zvec_db",
        ],
        "artifacts": [
            "seo/knowledge/wiki/project-manifest.json",
            "seo/knowledge/wiki/state/latest-summary.md",
            "seo/knowledge/wiki/context/latest-context-pack.md",
            "seo/knowledge/wiki/frameworks/review-cluster-plan.md",
            "seo/knowledge/wiki/api-catalog/api-catalog.json",
            "seo/knowledge/graph/graphify-status.json",
            "seo/knowledge/zvec/zvec-status.json",
        ],
    ...
    },
    {
        ...
        "policy_keys": [
            ...
            "xmlriver_health_report",
            "xmlriver_health_json",
            "writerzen_health_report",
            "writerzen_health_json",
        ],
        "artifacts": [
            ...
            "seo/setup/writerzen-browser-collect.md",
        ],
    ...
    },
    {
        ...
        "policy_keys": [
            ...
            "gsc_indexing_export_report",
            "gsc_indexing_export_json",
            "gsc_indexing_queue_report",
            "gsc_indexing_queue_json",
            "gsc_indexing_queue_csv",
            "gsc_indexing_submit_report",
            "gsc_indexing_submit_json",
            "gsc_indexing_recheck_report",
            "gsc_indexing_recheck_json",
            "indexnow_submit_report",
            "indexnow_submit_json",
            "indexnow_submit_csv",
            "yandex_recrawl_submit_report",
            "yandex_recrawl_submit_json",
            "yandex_recrawl_submit_csv",
            "yandex_recrawl_status_report",
            "yandex_recrawl_status_json",
            "yandex_recrawl_status_csv",
        ...
        "artifacts": [
            ...
            "seo/technical/gsc-indexing-export.md",
            "seo/technical/gsc-indexing-queue.md",
            "seo/technical/indexnow-submit.md",
            "seo/technical/yandex-recrawl-submit.md",
