...
FEATURES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "artifacts": ["seo/research-package/research-package-action-plan.md", "seo/research-package/serp-validation-plan.csv"],
        ...
        "notes": "Run the specific repair scripts from the action plan; the layer writes reviewable artifacts and does not publish or call paid APIs.",
    },
    {
