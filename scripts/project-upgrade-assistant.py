...
FEATURES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "default_answer": "yes",
        "command": "python3 ~/.codex/skills/seo-cycle/scripts/page-outline-v3.py seo/research-package --all-mvp --write && python3 ~/.codex/skills/seo-cycle/scripts/page-outline-quality.py seo/research-package --version v3 --write --format markdown",
        "notes": "Generates copywriter-ready briefs and checks word-count drift, SERP/page-type lock, tool-first ordering, SEO meta, schema, links, Answer Units, evidence, entities/triplets, visuals and fabricated first-person expertise.",
    },
    {
    ...
    },
    {
        ...
        "question": "Enable token waste audit plus Perplexity/NotebookLM/XMLRiver health reports for low-token evidence workflows?",
        "default_answer": "yes_report_only",
        "command": "python3 ~/.codex/skills/seo-cycle/scripts/token-waste-audit.py --write && python3 ~/.codex/skills/seo-cycle/scripts/perplexity-health.py --write && python3 ~/.codex/skills/seo-cycle/scripts/notebooklm-health.py --write && python3 ~/.codex/skills/seo-cycle/scripts/xmlriver-health.py --write",
        "notes": "Report-only. Perplexity uses persistent browser/app when available, no password storage; NotebookLM falls back to browser/manual source-pack export if MCP tools are unavailable; XMLRiver lists cheap SERP/Wordstat capabilities and env names without live paid calls.",
    },
    {
