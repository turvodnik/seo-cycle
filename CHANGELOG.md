...
- Новый тест `tests/test_docs_links.py`: относительные markdown-ссылки в README/INSTALL/
  GUIDE/SKILL/docs резолвятся на существующие файлы; ни один markdown не содержит
  строку вида `ИМЯ=<значение ≥16 символов>` — сторож от повторного появления
  примеров-секретов.
