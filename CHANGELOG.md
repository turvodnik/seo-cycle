...
файле или в замене никогда не роняет прогон; все шаблоны — ASCII, для
валидного ввода результат побайтно тот же, что в UTF-8-локали; литералы с
кириллицей вроде `city: "Москва"` совпадают побайтно).
